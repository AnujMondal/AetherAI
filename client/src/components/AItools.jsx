  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            <h2 className='text-slate-700 text-[42px] font-semibold'>Advanced AI Utilities</h2>
            <p className='text-gray-500 max-w-lg mx-auto'>All the essentials for crafting, refining, and perfecting your content using state-of-the-art artificial intelligence.</p>
        </div>
